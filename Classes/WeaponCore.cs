...
namespace DivBuildApp
{
    ...
    internal class Weapon
    {
        ...
        public WeaponModFormat[] WeaponMods { get; set; }
        public WeaponStatsFormat WeaponStats { get; set; }
        public string Talent { get; set; }
        public int Expertiece { get; set; }

        public Weapon(string name, string varient, WeaponType type, string rarity, Bonus[] statAttributes, WeaponModFormat[] weaponMods, string talent, int expertiece)
        {
            Name = name;
            Varient = varient;
            Type = type;
